from ActivationMapExtractor import show_activation_maps, load_model_from_config_file, save_all_activation_maps
...
if __name__ == "__main__":
    ...
    #TODO: create and train a model without nn sequential to get the layer names instead of .0 .1 , ... 


    """"
    UserWarning: Matplotlib is currently using agg, which is a non-GUI backend, so cannot show the figure.
    -> To resolve this and see the matplotlib window : sudo apt-get install python3-tk
    """